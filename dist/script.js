...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); // checkNumImputs('input[name="user_phone"]');
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'Файл на выбран';
    });
  };
...
var modals = function modals() {
  ...
  function calcScroll() {
    ...
    div.style.backgroundColor = '#f7e7e6';
  ...
  bindModal('.button-consultation', '.popup-design', '.popup-consultation .popup-close');
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true);
  openByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 1000);
};
